...
- [10 — Alert Correlation](../10-alert-correlation/README.vi.md) — nhận các sự kiện bất thường
- [11 — Root Cause Analysis](../11-root-cause-analysis/README.vi.md) — sử dụng ngữ cảnh bất thường
- [12 — LLM Agent](../12-investigation-engine/README.vi.md) — sử dụng tín hiệu bất thường phục vụ điều tra sự cố
- [14 — Production Operations](../14-production-engine/README.vi.md) — vận hành detector trên production, SLO platform
- [15 — Pattern Library](../15-aiops-pattern-library/README.vi.md) — pattern detection và production forces
- [16 — Domain Packs](../16-aiops-domain-packs/README.vi.md) — peak, calendar, compliance và money-path detection
- [17 — Benchmark Replay](../17-aiops-benchmark-replay/README.vi.md) — drift, confounder và long-incident scenarios

## Next Reading

Sau chương này, hãy chuyển sang [10 — Alert Correlation](../10-alert-correlation/README.vi.md).
...
Xem thêm seasonality semantics tại [16 — Domain Packs](../16-aiops-domain-packs/README.vi.md) và regression scenarios tại [17 — Benchmark Replay](../17-aiops-benchmark-replay/README.vi.md).
...
Liên hệ vận hành platform-level: [14 — Production](../14-production-engine/README.vi.md). Cách chọn detection pattern theo tier: [15 — Pattern Library](../15-aiops-pattern-library/README.vi.md).
