# Chapter 17 — AIOps Benchmark Replay: chứng minh engine trên incident timeline
...
- Chapter 15 cung cấp pattern và failure mode.
- Chapter 16 cung cấp domain semantics và invariants.
- Chapter 17 cung cấp timeline, ground truth, hard gates và scorer.
