...
- [09 — Anomaly Detection](../09-anomaly-detection/README.vi.md) — các tín hiệu bất thường làm đầu vào cho RCA
- [10 — Alert Correlation](../10-alert-correlation/README.vi.md) — các nhóm incident tương quan
...
- [12 — LLM Agent](../12-investigation-engine/README.vi.md) — sử dụng đầu ra của RCA để điều tra và xử lý
- [13 — Remediation](../13-remediation-safety-engine/README.vi.md) — kết quả RCA giúp định hướng lựa chọn phương án khắc phục
- [14 — Production Operations](../14-production-engine/README.vi.md) — đo accuracy RCA, game day drills
- [15 — Pattern Library](../15-aiops-pattern-library/README.vi.md) — causal diagnosis patterns
- [16 — Domain Packs](../16-aiops-domain-packs/README.vi.md) — RCA cho payment cascade và fraud confounders
- [17 — Benchmark Replay](../17-aiops-benchmark-replay/README.vi.md) — correlation≠causation scenarios

## Next Reading

Sau chương này, hãy chuyển sang [12 — LLM Agent](../12-investigation-engine/README.vi.md).
...
| Change events | CI/CD, GitOps, flag, infra ticket ([08](../08-topology-change/README.vi.md)) | Ứng viên nguyên nhân |
...
Bài kiểm chứng outage class: [17 — Benchmark Replay](../17-aiops-benchmark-replay/README.vi.md).
...
Drill RCA bằng [17 — Benchmark Replay](../17-aiops-benchmark-replay/README.vi.md) · vận hành accuracy: [14 — Production](../14-production-engine/README.vi.md).
