...
> **Chương vận hành production cho chính nền tảng AIOps: chaos engineering, disaster recovery, cost governance, security hardening, performance benchmarking, và runbooks giữ hệ thống khỏe mạnh. Bản thân nền tảng giám sát production bắt buộc phải đạt chuẩn production. Sau chương này, hãy đọc tiếp các chương case study: [13 — Big Tech](../13-bigtech-aiops/README.vi.md), [14 — E-commerce & Banking](../14-ecommerce-banking/README.vi.md), [15 — Famous Incidents](../15-famous-incidents/README.vi.md).**
...
- [07 — Anomaly Detection](../07-anomaly-detection/README.vi.md) — precision-at-page, drift ops
- [08 — Alert Correlation](../08-alert-correlation/README.vi.md) — storm drills, topology health
- [09 — Root Cause Analysis](../09-root-cause-analysis/README.vi.md) — accuracy feedback, time budget
- [10 — LLM Agent](../10-llm-agent/README.vi.md) — cost runaway LLM, human override
- [11 — Remediation](../11-remediation/README.vi.md) — safety gates, blast radius
- [13 — Big Tech AIOps](../13-bigtech-aiops/README.vi.md) — operating models & maturity at scale
- [14 — E-commerce & Banking](../14-ecommerce-banking/README.vi.md) — cost/compliance constraints by industry
- [15 — Famous Incidents](../15-famous-incidents/README.vi.md) — game day scenarios từ outage công khai

## Next Reading

Sau chương này, hãy chuyển sang [13 — Big Tech AIOps](../13-bigtech-aiops/README.vi.md) để học pattern từ Google/Netflix/AWS/Meta/Uber, rồi [14 — E-commerce & Banking](../14-ecommerce-banking/README.vi.md) và [15 — Famous Incidents](../15-famous-incidents/README.vi.md).
...
Xem thêm kịch bản DR/outage công khai để drill: [15 — Famous Incidents](../15-famous-incidents/README.vi.md).
...
| Bi-annual | Famous incident replay | Organizational learning | [15 — Famous Incidents](../15-famous-incidents/README.vi.md) |
...
Big Tech patterns để benchmark: [13 — Big Tech AIOps](../13-bigtech-aiops/README.vi.md). Industry constraints: [14 — E-commerce & Banking](../14-ecommerce-banking/README.vi.md).
...
Cross-read: [13 — Big Tech AIOps](../13-bigtech-aiops/README.vi.md) · [14 — E-commerce & Banking](../14-ecommerce-banking/README.vi.md) · [15 — Famous Incidents](../15-famous-incidents/README.vi.md).
