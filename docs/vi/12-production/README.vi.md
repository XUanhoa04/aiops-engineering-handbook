...
> **Chương cuối cùng này bao gồm mọi thứ cần thiết để tự vận hành chính nền tảng AIOps trên môi trường production: chaos engineering, phục hồi sau thảm họa (disaster recovery), quản trị chi phí (cost governance), thắt chặt bảo mật (security hardening), đo kiểm hiệu năng (performance benchmarking), và các tài liệu runbooks hướng dẫn vận hành giữ cho hệ thống luôn khỏe mạnh. Bản thân nền tảng giám sát hệ thống production bắt buộc phải đạt tiêu chuẩn chất lượng production.**
