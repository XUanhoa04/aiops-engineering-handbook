...
- [09 — Anomaly Detection](../09-anomaly-detection/README.vi.md) — feature `deploy_age`, `change_in_window`
- [10 — Alert Correlation](../10-alert-correlation/README.vi.md) — topology-aware grouping
- [11 — Root Cause Analysis](../11-root-cause-analysis/README.vi.md) — change-driven RCA, graph walk
- [12 — LLM Agent](../12-investigation-engine/README.vi.md) — context pack: owner, deps, recent changes
- [13 — Remediation](../13-remediation-safety-engine/README.vi.md) — blast radius, freeze, dual-control
- [14 — Production](../14-production-engine/README.vi.md) — platform SLO, game days
- [15 — Pattern Library](../15-aiops-pattern-library/README.vi.md) — topology-aware correlation và stale-graph patterns
- [16 — Domain Packs](../16-aiops-domain-packs/README.vi.md) — payment path, audit và dual-control semantics
- [17 — Benchmark Replay](../17-aiops-benchmark-replay/README.vi.md) — cascade, partial failure và change-confounder scenarios

## Next Reading

Sau chương này, chuyển sang [09 — Anomaly Detection](../09-anomaly-detection/README.vi.md), rồi [10 — Alert Correlation](../10-alert-correlation/README.vi.md) và [11 — Root Cause Analysis](../11-root-cause-analysis/README.vi.md). Ch.06–07 đã tạo canonical event bus; chương này bổ sung topology/change context trước khi intelligence plane bắt đầu ra quyết định.
...
- Feature `deploy_age_minutes` trong [09](../09-anomaly-detection/README.vi.md) và feature store [06](../06-data-plane/README.vi.md) **phụ thuộc** change plane.
...
| Correlation (Ch.10) | Edges, tiers | Optional suppress during deploy | <500ms group window | Graph age < SLO |
| RCA (Ch.11) | Walk / rank | Strong prior | Seconds OK | As-of incident start |
| LLM context (Ch.12) | Owner, deps summary | Last N changes | Seconds | Prefer snapshot id |
| Remediation (Ch.13) | Blast radius subgraph | Freeze + dual-control | Hard real-time gate | **Fresh + authoritative** |
...
**Không đủ** khi payment path có 8 hop ([16](../16-aiops-domain-packs/README.vi.md), [diagram payment path](../../assets/diagrams/08-payment-critical-path.png)).
...
Burn error budget topology → **freeze** feature flags bật topo-auto-remediation (liên hệ [14](../14-production-engine/README.vi.md)).
...
Nguồn: session recording (Teleport), `kubectl` audit, AWS Console — normalize best-effort; **missing manual change** là blind spot lớn (xem [17](../17-aiops-benchmark-replay/README.vi.md)).
...
> [!NOTE]
> **Ý TƯỞNG**
> “Deploy rồi alert” **không** chứng minh nhân quả. Traffic spike, batch job, multi-deploy, shared library bump, upstream SaaS — đều là **confounders**. Change correlation = prior mạnh cho RCA, không phải verdict tuyệt đối ([11](../11-root-cause-analysis/README.vi.md)).
...
Từ [09](../09-anomaly-detection/README.vi.md) / feature store:
...
### 10.6 Correlation engine use (Ch.10)
...
> [!IMPORTANT]
> Compound failure là norm trong commerce peak ([16](../16-aiops-domain-packs/README.vi.md), [17](../17-aiops-benchmark-replay/README.vi.md)). Change correlation đơn nhân là anti-pattern nhận thức.
...
> [!NOTE]
> **Ý TƯỞNG**
> Remediation an toàn ([13](../13-remediation-safety-engine/README.vi.md)) cần **dual-control với change calendar**: không auto-restart payment lúc freeze Black Friday chỉ vì RCA tự tin 0.9. Freeze và risk score là **gates**, không decoration.
...
Hai approver roles khác nhau; maker ≠ checker; mọi decision immutable log ([16](../16-aiops-domain-packs/README.vi.md)).
...
### 13.2 Contract với Ch.10 Correlation
...
Topology-aware stage: [10](../10-alert-correlation/README.vi.md).

### 13.3 Contract với Ch.11 RCA
...
Change correlation section trong RCA: [11](../11-root-cause-analysis/README.vi.md).

### 13.4 Contract với Ch.12 LLM
...
### 13.5 Contract với Ch.13 Remediation
...
> [!NOTE]
> **Ý TƯỞNG**
> Ở banking/e-commerce regulated ([16](../16-aiops-domain-packs/README.vi.md)), topology không chỉ kỹ thuật — là **bản đồ trách nhiệm và blast radius tiền**. Mọi chỉnh sửa ownership/tier/edges declared phải audit được như change production.
...
| Mid 50–150 eng | L3 |
| Large / bank | L4 |
| Hyperscale | L5 patterns chọn lọc ([15](../15-aiops-pattern-library/README.vi.md)) |
...
8. [ ] Payment/money path declared & reviewed ([16](../16-aiops-domain-packs/README.vi.md)).
...
50. [ ] Game day: deploy bad + topo/change assisted recovery ([14](../14-production-engine/README.vi.md)).
...
- [11 — RCA](../11-root-cause-analysis/README.vi.md)
- [12 — LLM Agent](../12-investigation-engine/README.vi.md)
- [13 — Remediation](../13-remediation-safety-engine/README.vi.md)
...
*Chapter 08 — Topology & Change Data Plane · AIOps Engineering Handbook · VI*
