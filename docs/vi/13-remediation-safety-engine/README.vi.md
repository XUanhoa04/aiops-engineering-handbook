...
- [11 — Root Cause Analysis](../11-root-cause-analysis/README.vi.md): đưa ra candidate và causal evidence, không phải quyền hành động.
- [12 — Investigation Engine](../12-investigation-engine/README.vi.md): cung cấp incident revision, hypothesis, evidence và proposal có giới hạn.
- [08 — Topology & Change Intelligence](../08-topology-change/README.vi.md): cung cấp dependency, ownership, shared resource và change state.
- [14 — Production Engine](../14-production-engine/README.vi.md): quy định degraded mode, audit, disaster recovery và kill switch.
