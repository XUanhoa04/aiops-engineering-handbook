# Chapter 12 — Investigation Engine: từ tín hiệu rời rạc đến kết luận có bằng chứng
...
- [09 — Anomaly Detection](../09-anomaly-detection/README.vi.md): tạo tín hiệu bất thường nhưng chưa khẳng định nguyên nhân.
- [10 — Alert Correlation](../10-alert-correlation/README.vi.md): gom triệu chứng thành incident và tách các fault độc lập.
- [11 — Root Cause Analysis](../11-root-cause-analysis/README.vi.md): xếp hạng root-cause candidate bằng topology, trace, thời gian và multi-signal scoring.
- [08 — Topology & Change Intelligence](../08-topology-change/README.vi.md): cung cấp dependency graph, ownership và lịch sử thay đổi.
...
RCA engine của Chapter 11 trả về bốn candidate:
...
Investigation tool chỉ đọc. “Lấy log bằng cách bật debug”, “kiểm tra bằng cách restart pod” hoặc “thử scale lên xem sao” đều là production action và phải sang Chapter 13. Không được ngụy trang mutation thành bước điều tra.
...
Nếu đề xuất action, report phải có evidence revision, target scope, expected outcome, invariant và lý do không chọn action khác. Chapter 12 không phê duyệt hay thực thi action.
...
Giá trị của Chapter 12 không nằm ở việc LLM viết report nhanh hơn. Giá trị nằm ở một quy trình điều tra có kỷ luật:
