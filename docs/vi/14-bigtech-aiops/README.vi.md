# Chapter 14 — AIOps Pattern Library: chọn pattern theo lực tác động, không theo tên công ty
...
- Domain Packs ở Chapter 15 có thể tham chiếu pattern bằng tên ổn định.
- Benchmark Replay ở Chapter 16 có scenario chứng minh từng pattern.
