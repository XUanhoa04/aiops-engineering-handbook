# Chapter 14 — AIOps & SRE tại các tập đoàn lớn
...
- [07 — Anomaly Detection](../08-anomaly-detection/README.vi.md) — tín hiệu bất thường, false positive economics
- [09 — Root Cause Analysis](../10-root-cause-analysis/README.vi.md) — topology, change correlation, evidence ranking
- [11 — Automated Remediation](../12-remediation/README.vi.md) — safety gate, blast radius, dual-control
- [12 — Production Operations](../13-production/README.vi.md) — chaos, DR, runbook, platform self-observability

## Related Documents

- [08 — Alert Correlation](../09-alert-correlation/README.vi.md) — giảm nhiễu, incident grouping
- [10 — LLM Agent](../11-llm-agent/README.vi.md) — agentic investigation, human-in-the-loop
- [06 — Kafka](../07-kafka/README.vi.md) — event backbone cho pipeline AIOps

## Next Reading

Sau chương này, chuyển sang [14 — E-commerce & Banking](../15-ecommerce-banking/README.vi.md) để áp dụng pattern theo domain tiền/giao dịch; rồi [15 — Famous Incidents](../16-famous-incidents/README.vi.md) để drill postmortem. Có thể quay lại [12 — Production](../13-production/README.vi.md) với checklist Big Tech.
...
4. **Cargo cult autonomy**: auto-remediation “full closed loop” khi chưa có dual-control, audit trail, và blast radius model — xem [11 — Remediation](../12-remediation/README.vi.md).
...
- Ticket AIOps phải có schema hỗ trợ handoff: timeline, hypotheses, actions taken, blast radius — xem [09 — RCA](../10-root-cause-analysis/README.vi.md) và [10 — LLM Agent](../11-llm-agent/README.vi.md).
...
5. Post-experiment note gắn vào knowledge base (feed [10 — LLM Agent](../11-llm-agent/README.vi.md)).

### 3.5 Bài học Netflix cho AIOps

1. **Resilience là product requirement**, không phải afterthought của detection.
2. **Steady-state metrics** phải nằm trong anomaly baselines — xem seasonality ở [07](../08-anomaly-detection/README.vi.md).
...
Liên hệ [12 — Production](../13-production/README.vi.md) mục chaos cho chính nền tảng AIOps: platform giám sát cũng phải chịu được mất Kafka partition, mất LLM provider, mất một collector — nếu không, AIOps trở thành single point of blindness.
...
Kết nối trực tiếp [11 — Remediation](../12-remediation/README.vi.md):
...
Từ góc [08 — Alert Correlation](../09-alert-correlation/README.vi.md) và [09 — RCA](../10-root-cause-analysis/README.vi.md):
...
> [!NOTE]
> **Ý TƯỞNG**
> Nhiều “ML anomaly không work” không phải thuật toán kém — mà là **data contract kém**. Trước khi đổi LSTM sang Transformer, hãy audit train/serve skew. Xem feature engineering trong [07 — Anomaly Detection](../08-anomaly-detection/README.vi.md).
...
Bài học AIOps (khớp [06 — Kafka](../07-kafka/README.vi.md)):
...
> [!TIP]
> **Meta-observability**
> Big Tech học sớm: *hệ thống quan sát cũng là production system*. Nếu Kafka lag 15 phút, “real-time anomaly” là marketing. Đo pipeline SLI riêng — xem [12](../13-production/README.vi.md).
...
**Xử lý:** private model / VPC endpoint / redaction layer; tool outputs minimize PII — xem [10](../11-llm-agent/README.vi.md) và security ở [12](../13-production/README.vi.md).
...
| Thuật toán detection | [07 — Anomaly Detection](../08-anomaly-detection/README.vi.md) |
| Gom nhiễu | [08 — Alert Correlation](../09-alert-correlation/README.vi.md) |
| Chẩn đoán | [09 — Root Cause Analysis](../10-root-cause-analysis/README.vi.md) |
| Agent điều tra | [10 — LLM Agent](../11-llm-agent/README.vi.md) |
| Hành động an toàn | [11 — Remediation](../12-remediation/README.vi.md) |
| Vận hành nền tảng | [12 — Production](../13-production/README.vi.md) |
...
Liên hệ implement chi tiết: [11 — Remediation](../12-remediation/README.vi.md).
...
Hãy mang checklist §12 vào [12 — Production](../13-production/README.vi.md), mang train/serve discipline vào [07](../08-anomaly-detection/README.vi.md), mang dual-control vào [11](../12-remediation/README.vi.md), mang SLO culture vào [01](../01-observability/README.vi.md). Big Tech không cần bạn giống họ — họ cần (và bạn cần) hệ thống của bạn **hiểu giới hạn của chính nó**.
