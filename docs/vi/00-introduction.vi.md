...
- [07 — Anomaly Detection](07-anomaly-detection/README.vi.md)
- [12 — Production](12-production/README.vi.md)
- [13 — Big Tech AIOps Case Studies](13-bigtech-aiops/README.vi.md) *(case study tóm tắt; chi tiết ở chương riêng)*
- [14 — E-commerce & Banking Patterns](14-ecommerce-banking/README.vi.md)
- [15 — Famous Incidents](15-famous-incidents/README.vi.md)
...
> [!TIP]
> Case study big tech (tóm tắt): nhiều tổ chức hyperscale công bố giảm noise 80–95% nhờ correlation + topology, rồi mới nói tới auto-remediation. Chi tiết và pattern theo ngành xem [13 — Big Tech AIOps](13-bigtech-aiops/README.vi.md) và [14 — E-commerce & Banking](14-ecommerce-banking/README.vi.md).
...
- Liên hệ incident lịch sử (retry storm, partial brownout): agent kém topology có thể **khuếch đại** thay vì chữa. Xem [15 — Famous Incidents](15-famous-incidents/README.vi.md).
...
Ngành dọc (pattern ROI khác nhau) được phân tích sâu hơn ở [14 — E-commerce & Banking](14-ecommerce-banking/README.vi.md).
...
Nhiều tổ chức lớn công bố: sau khi có **mandatory incident tagging** + offline evaluation, precision detector tăng dần theo quý — không phải nhờ model phức tạp hơn, mà nhờ **dữ liệu phản hồi**. Chi tiết pattern: [13 — Big Tech AIOps](13-bigtech-aiops/README.vi.md).
...
Các postmortem công khai kinh điển (cascade, config, retry) được tổng hợp tại [15 — Famous Incidents](15-famous-incidents/README.vi.md).
...
- Handbook chapters: [13 Big Tech](13-bigtech-aiops/README.vi.md) · [14 E-commerce & Banking](14-ecommerce-banking/README.vi.md) · [15 Famous Incidents](15-famous-incidents/README.vi.md)
