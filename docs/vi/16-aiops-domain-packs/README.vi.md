# Chapter 16 — AIOps Domain Packs: e-commerce, banking và payment
...
Pattern chỉ được coi là áp dụng thành công khi Domain Pack có golden replay và hard gates. Chapter 17 biến chính các scenarios này thành benchmark chạy lặp lại cho mọi thay đổi của AIOps engine.
