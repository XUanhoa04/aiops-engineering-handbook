...
- [11 — Root Cause Analysis](../11-root-cause-analysis/README.md) — RCA results as the primary input
- [10 — Alert Correlation](../10-alert-correlation/README.md) — Correlated incident context
...
- [13 — Remediation](../13-remediation-safety/README.md) — LLM Agent triggers remediation actions
- [03 — Prometheus](../03-prometheus/README.md) — LLM Agent queries for metrics context
- [14 — Production Operations](../14-production-engine/README.md) — cost governance LLM, dogfooding, DR control plane
- [15 — Big Tech AIOps](../15-bigtech-aiops/README.md) — AI SRE / copilot patterns at Big Tech
- [16 — E-commerce & Banking](../16-ecommerce-banking/README.md) — compliance constraints when the agent reads PII logs
- [17 — Famous Incidents](../17-famous-incidents/README.md) — lessons on automation overreach & human override

## Next Reading

After this chapter, continue to [13 — Remediation](../13-remediation-safety/README.md).
...
PII log compliance details: [16 — E-commerce & Banking](../16-ecommerce-banking/README.md).
...
Automation overreach postmortems: [17 — Famous Incidents](../17-famous-incidents/README.md).
...
Cost/DR operations: [14 — Production](../14-production-engine/README.md) · Big Tech patterns: [15 — Big Tech AIOps](../15-bigtech-aiops/README.md).
