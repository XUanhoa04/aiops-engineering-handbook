...
- [10 — Alert Correlation](../10-alert-correlation/README.md) — topology-aware grouping; stale-graph degradation
- [11 — Root Cause Analysis](../11-root-cause-analysis/README.md) — topology traversal + change correlation
- [13 — Remediation](../13-remediation-safety/README.md) — blast radius, freeze, allow-list gates
- [14 — Production Operations](../14-production-engine/README.md) — control plane vs data plane, game days

## Related Documents

- [09 — Anomaly Detection](../09-anomaly-detection/README.md) — change-aware suppression / warm-start baselines
- [12 — LLM Investigation Agent](../12-investigation-engine/README.md) — context packs need neighbors + recent changes
- [15 — Big Tech AIOps](../15-bigtech-aiops/README.md) — dependency inventory and correlation at scale
- [16 — E-commerce & Banking](../16-ecommerce-banking/README.md) — multi-region graphs, payment critical path, dual-control
- [17 — Famous Incidents](../17-famous-incidents/README.md) — missing edges, ops-tool changes, shared-fate dependencies

## Next Reading

Continue to [09 — Anomaly Detection](../09-anomaly-detection/README.md), then [10 — Alert Correlation](../10-alert-correlation/README.md) and [11 — Root Cause Analysis](../11-root-cause-analysis/README.md). Chapters 06–07 establish the canonical event bus; this chapter adds topology and change context before the intelligence plane starts making decisions.
...
| [09 Anomaly Detection](../09-anomaly-detection/README.md) | Dependency fan-in features | Suppress / warm-start after deploy |
| [10 Correlation](../10-alert-correlation/README.md) | Merge by edge path | Group post-deploy regressions |
| [11 RCA](../11-root-cause-analysis/README.md) | Upstream walk, shared deps | Change correlation scores |
| [12 LLM Agent](../12-investigation-engine/README.md) | Neighbor subgraph in context pack | “What shipped in last 60m?” |
| [13 Remediation](../13-remediation-safety/README.md) | Blast radius, critical path | Freeze gates, rollback candidates |
| [14 Production](../14-production-engine/README.md) | Game-day dependency maps | Change freeze policy enforcement |
...
- Guarantee causal truth from edges (see [11 — RCA](../11-root-cause-analysis/README.md) confounders)
...
Align with the lesson in [17 — Famous Incidents](../17-famous-incidents/README.md) and poster [control vs data plane](../../assets/diagrams/07-control-vs-data-plane.png): **do not host the only copy of freeze state or critical graph snapshots solely on the region that freezes first.**
...
| Node type | When |
|-----------|------|
| `dns_zone` / `dns_record` | DNS automation incidents ([17](../17-famous-incidents/README.md)) |
...
> [!WARNING]
> Do not treat **all** edges as causal “A fails ⇒ B fails.” An `rpc` edge is a **possible** failure path. RCA still needs time order, change context, and confounder policy ([11](../11-root-cause-analysis/README.md)).
...
| `pci` / `pii` flags | Remediation dual-control ([16](../16-ecommerce-banking/README.md)) |
...
| `critical_path` | Boolean for money path ([16](../16-ecommerce-banking/README.md)) |
...
> [!NOTE]
> **KEY IDEA**
> Most serious incidents have a **change nearby**. If your change taxonomy only includes “git deploy,” you will miss config, flags, DNS, capacity tools, and schema migrations — the classes that dominate famous outages ([17](../17-famous-incidents/README.md)).
...
From incident literature and [17](../17-famous-incidents/README.md):
...
This is non-negotiable for [13 Remediation](../13-remediation-safety/README.md) learning loops and for postmortems that look like S3-2017 class events.
...
Pair with freeze windows: many banks ban migrations outside windows ([16](../16-ecommerce-banking/README.md)).
...
Align with domain retention in [16](../16-ecommerce-banking/README.md) for regulated change audit.
...
### 13.2 Anomaly detection ([09](../09-anomaly-detection/README.md))
...
### 13.3 Alert correlation ([10](../10-alert-correlation/README.md))
...
### 13.4 RCA ([11](../11-root-cause-analysis/README.md))
...
### 13.5 LLM agent ([12](../12-investigation-engine/README.md))
...
### 13.6 Remediation ([13](../13-remediation-safety/README.md))
...
Align with [10 §19.1](../10-alert-correlation/README.md).
...
For money path ([16](../16-ecommerce-banking/README.md) poster [payment path](../../assets/diagrams/08-payment-critical-path.png)):
...
Prefer **replicate snapshots** regionally with `graph_version` vectors; never hard-depend on a single region’s live builder during that region’s incident ([17](../17-famous-incidents/README.md)).
...
Regulated environments: map change ledger to change-management ticket IDs ([16](../16-ecommerce-banking/README.md)).
...
**Lesson:** network automation is a change producer ([17](../17-famous-incidents/README.md)).
...
**Questions:** How does confounder policy work ([11](../11-root-cause-analysis/README.md))? What graph query separates shared dependency vs deploy regression? When is rollback wrong?
...
| Change-aware detection | [09 — Anomaly Detection](../09-anomaly-detection/README.md) |
| Topology merge & stale guards | [10 — Alert Correlation](../10-alert-correlation/README.md) |
| Change correlation & confounders | [11 — RCA](../11-root-cause-analysis/README.md) |
| Context packs | [12 — LLM Agent](../12-investigation-engine/README.md) |
| Gates & verify | [13 — Remediation](../13-remediation-safety/README.md) |
| Game days & HA | [14 — Production](../14-production-engine/README.md) |
| Domain constraints | [16 — E-commerce & Banking](../16-ecommerce-banking/README.md) |
| Missing edges in real outages | [17 — Famous Incidents](../17-famous-incidents/README.md) |
...
- [10 — Alert Correlation](../10-alert-correlation/README.md)
- [11 — Root Cause Analysis](../11-root-cause-analysis/README.md)
- [12 — LLM Investigation Agent](../12-investigation-engine/README.md)
- [13 — Remediation](../13-remediation-safety/README.md)
- [14 — Production Operations](../14-production-engine/README.md)
- [15 — Big Tech AIOps](../15-bigtech-aiops/README.md)
- [16 — E-commerce & Banking](../16-ecommerce-banking/README.md)
...
- Richard Cook, *How Complex Systems Fail* — latent conditions & coupling (see [17](../17-famous-incidents/README.md))
