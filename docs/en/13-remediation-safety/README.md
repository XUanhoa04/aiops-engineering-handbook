# Chapter 13 — Automated Remediation
...
- [11 — Root Cause Analysis](../11-root-cause-analysis/README.md) — produces remediation trigger signals; **wrong RCA → wrong action**
- [12 — LLM Agent](../12-investigation-engine/README.md) — proposes actions; **never freeform shell**
- [07 — Kafka](../07-kafka/README.md) — transport layer for trigger signals and remediation results

## Related Documents

- [03 — Prometheus](../03-prometheus/README.md) — verify remediation outcomes via metrics (verification loop)
- [14 — Production Operations](../14-production-engine/README.md) — runbook, GitOps, chaos, change freeze
- [16 — E-commerce & Banking](../16-ecommerce-banking/README.md) — dual-control, audit log for regulators
- [17 — Famous Incidents](../17-famous-incidents/README.md) — S3, thundering herd, cascade failure lessons

## Next Reading

After this chapter, continue to [14 — Production Operations](../14-production-engine/README.md), then [16 — E-commerce & Banking](../16-ecommerce-banking/README.md) and [17 — Famous Incidents](../17-famous-incidents/README.md).
...
Cross-link: [11 — RCA](../11-root-cause-analysis/README.md) · [12 — LLM](../12-investigation-engine/README.md) · [17 — Incidents](../17-famous-incidents/README.md).
...
> [!TIP]
> **Map tier → executor**
> Tier 1 → K8s/SSM executor + verification. Tier 2 → Slack/PagerDuty dual-control (or single approve + canary). Tier 3 → GitOps PR + change ticket ([§10](#10-gitops-remediation), [14 — Production](../14-production-engine/README.md)).
...
> Document `aiops-flush-elasticache` is only safe if parameters are whitelisted + dual-control. **Forbid** LLM-supplied arbitrary `commands[]`. Banking/PCI: prefer managed APIs (ElastiCache API) over shell on bastion — [16 — Banking](../16-ecommerce-banking/README.md).
...
> The 0.75 threshold is only policy. Combining evidence score from [11 — RCA](../11-root-cause-analysis/README.md) (multi-signal) matters more than one model float. Wrong RCA + high confidence = fast accident.
...
> Add: canary traffic %, dependency fan-out, shared DB/queue, multi-tenant blast, regulatory blast (PII path). Banking: actions touching core-ledger always `DO_NOT_AUTO_REMEDIATE` regardless of graph score — [16 — Banking](../16-ecommerce-banking/README.md).
...
> [!TIP]
> An auditor 3 years later must read *who / what action / which system / which incident / outcome / rollback?*. Missing one link = fail. Domain: [16 — Banking](../16-ecommerce-banking/README.md).
...
Cross-link: agent tool design in [12 — LLM Agent](../12-investigation-engine/README.md); chaos/runbook platform in [14 — Production](../14-production-engine/README.md).
...
Xem [17 — Famous Incidents](../17-famous-incidents/README.md), [11 — RCA](../11-root-cause-analysis/README.md).
...
> [!TIP]
> Chaos platform-wide: [14 — Production Operations](../14-production-engine/README.md).

---

## 25. Case Studies — Famous Incidents

Map lessons → controls (full: [17 — Famous Incidents](../17-famous-incidents/README.md)).
...
43. [ ] Cross-check RCA quality with [11](../11-root-cause-analysis/README.md)
44. [ ] Agent tools align with [12](../12-investigation-engine/README.md) — no ad-hoc dangerous tools
45. [ ] Banking controls review [16](../16-ecommerce-banking/README.md)
...
4. **Change-freeze windows**: During scheduled freezes (end of quarter, Black Friday), all Tier 2 remediations must auto-escalate to human approval before execution, even if normally auto-allowed. Integrate the remediation engine with the enterprise change calendar — [14 — Production](../14-production-engine/README.md).
...
6. **Capacity removal / wrong RCA**: Forbid capacity-removal action class during SEV; map lessons from [17 — Famous Incidents](../17-famous-incidents/README.md).
...
8. [11 — Root Cause Analysis](../11-root-cause-analysis/README.md)
9. [12 — LLM Agent](../12-investigation-engine/README.md)
10. [14 — Production Operations](../14-production-engine/README.md)
11. [16 — E-commerce & Banking](../16-ecommerce-banking/README.md)
12. [17 — Famous Incidents](../17-famous-incidents/README.md)
