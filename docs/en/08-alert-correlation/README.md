...
- [07 — Anomaly Detection](../07-anomaly-detection/README.md) — produces the anomaly events consumed here
...
- [09 — Root Cause Analysis](../09-root-cause-analysis/README.md) — receives correlated alert groups as input
- [10 — LLM Agent](../10-llm-agent/README.md) — uses correlation context for incident investigation
- [03 — Prometheus](../03-prometheus/README.md) — Alertmanager grouping (simple correlation level)
- [12 — Production Operations](../12-production/README.md) — correlation engine SLOs, storm drills
- [13 — Big Tech AIOps](../13-bigtech-aiops/README.md) — correlation / incident grouping at hyperscaler scale
- [14 — E-commerce & Banking](../14-ecommerce-banking/README.md) — multi-region cascade, payment fan-out storms
- [15 — Famous Incidents](../15-famous-incidents/README.md) — case studies of alert storms and correlated outages

## Next Reading

After this chapter, continue to [09 — Root Cause Analysis](../09-root-cause-analysis/README.md).
...
**Operational rule**: refresh graph every 5–15 minutes; metric `aiops_topology_graph_age_seconds`; page platform if age > 30 minutes. Multi-region graph details: [14 — E-commerce & Banking](../14-ecommerce-banking/README.md).
...
Multi-failure case studies: [15 — Famous Incidents](../15-famous-incidents/README.md).
...
Run periodic storm drills on game day: [12 — Production](../12-production/README.md). Big Tech patterns: [13 — Big Tech AIOps](../13-bigtech-aiops/README.md).
