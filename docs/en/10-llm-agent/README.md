...
- [09 — Root Cause Analysis](../09-root-cause-analysis/README.md) — RCA results as the primary input
...
- [12 — Production Operations](../12-production/README.md) — cost governance LLM, dogfooding, DR control plane
- [13 — Big Tech AIOps](../13-bigtech-aiops/README.md) — AI SRE / copilot patterns at Big Tech
- [14 — E-commerce & Banking](../14-ecommerce-banking/README.md) — compliance constraints when the agent reads PII logs
- [15 — Famous Incidents](../15-famous-incidents/README.md) — lessons on automation overreach & human override

## Next Reading

After this chapter, continue to [11 — Remediation](../11-remediation/README.md).
...
PII log compliance details: [14 — E-commerce & Banking](../14-ecommerce-banking/README.md).
...
Automation overreach postmortems: [15 — Famous Incidents](../15-famous-incidents/README.md).
...
Cost/DR operations: [12 — Production](../12-production/README.md) · Big Tech patterns: [13 — Big Tech AIOps](../13-bigtech-aiops/README.md).
