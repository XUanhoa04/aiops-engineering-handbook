...
- [09 — Anomaly Detection](../09-anomaly-detection/README.md) — produces the anomaly events consumed here
- [03 — Prometheus](../03-prometheus/README.md) — alert source via Alertmanager
- [07 — Kafka](../07-kafka/README.md) — transport layer for anomaly events

## Related Documents

- [11 — Root Cause Analysis](../11-root-cause-analysis/README.md) — receives correlated alert groups as input
- [12 — LLM Agent](../12-investigation-engine/README.md) — uses correlation context for incident investigation
- [03 — Prometheus](../03-prometheus/README.md) — Alertmanager grouping (simple correlation level)
- [14 — Production Operations](../14-production-engine/README.md) — correlation engine SLOs, storm drills
- [15 — Big Tech AIOps](../15-bigtech-aiops/README.md) — correlation / incident grouping at hyperscaler scale
- [16 — E-commerce & Banking](../16-ecommerce-banking/README.md) — multi-region cascade, payment fan-out storms
- [17 — Famous Incidents](../17-famous-incidents/README.md) — case studies of alert storms and correlated outages

## Next Reading

After this chapter, continue to [11 — Root Cause Analysis](../11-root-cause-analysis/README.md).
...
| Graph age / coverage metrics | Topology side plane ([08](../08-topology-change/README.md)) | Gate: use / degrade / disable topology |
...
> [!NOTE]
> This is still a **hypothesis for RCA**, not proof of causation. Chapter 11 adds change confounders, evidence quality, and multi-root. Correlation ≠ causation remains true.
...
| Changes | CI/CD / [08 Topology & Change](../08-topology-change/README.md) | Deploy within impact window |
...
**Operational rule**: refresh graph every 5–15 minutes; metric `aiops_topology_graph_age_seconds`; page platform if age > 30 minutes. Multi-region graph details: [16 — E-commerce & Banking](../16-ecommerce-banking/README.md).
...
Multi-failure case studies: [17 — Famous Incidents](../17-famous-incidents/README.md).
...
Run periodic storm drills on game day: [14 — Production](../14-production-engine/README.md). Big Tech patterns: [15 — Big Tech AIOps](../15-bigtech-aiops/README.md).
