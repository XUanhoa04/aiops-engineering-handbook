...
- [09 — Anomaly Detection](../09-anomaly-detection/README.md) — anomaly signals, false positive economics
- [11 — Root Cause Analysis](../11-root-cause-analysis/README.md) — topology, change correlation, evidence ranking
- [13 — Automated Remediation](../13-remediation-safety/README.md) — safety gate, blast radius, dual-control
- [14 — Production Operations](../14-production-engine/README.md) — chaos, DR, runbook, platform self-observability

## Related Documents

- [10 — Alert Correlation](../10-alert-correlation/README.md) — noise reduction, incident grouping
- [12 — LLM Agent](../12-investigation-engine/README.md) — agentic investigation, human-in-the-loop
- [07 — Kafka](../07-kafka/README.md) — event backbone for the AIOps pipeline

## Next Reading

After this chapter, continue to [16 — E-commerce & Banking](../16-ecommerce-banking/README.md) to apply patterns by money/transaction domain; then [17 — Famous Incidents](../17-famous-incidents/README.md) for postmortem drills. You can return to [14 — Production](../14-production-engine/README.md) with a Big Tech checklist.
...
4. **Cargo cult autonomy**: “full closed-loop” auto-remediation without dual-control, audit trail, and a blast radius model — see [13 — Remediation](../13-remediation-safety/README.md).
...
- AIOps tickets need a handoff schema: timeline, hypotheses, actions taken, blast radius — see [11 — RCA](../11-root-cause-analysis/README.md) and [12 — LLM Agent](../12-investigation-engine/README.md).
...
5. Post-experiment note attached to knowledge base (feeds [12 — LLM Agent](../12-investigation-engine/README.md)).

### 3.5 Netflix lessons for AIOps

1. **Resilience is a product requirement**, not an afterthought of detection.
2. **Steady-state metrics** must live in anomaly baselines — see seasonality in [09](../09-anomaly-detection/README.md).
...
See [14 — Production](../14-production-engine/README.md) on chaos for the AIOps platform itself: the monitoring platform must survive losing a Kafka partition, an LLM provider, or one collector — otherwise AIOps becomes a single point of blindness.
...
Direct connection to [13 — Remediation](../13-remediation-safety/README.md):
...
From [10 — Alert Correlation](../10-alert-correlation/README.md) and [11 — RCA](../11-root-cause-analysis/README.md):
...
> [!NOTE]
> **KEY IDEA**
> Many “ML anomaly does not work” cases are not weak algorithms — they are **weak data contracts**. Before swapping LSTM for Transformer, audit train/serve skew. See feature engineering in [09 — Anomaly Detection](../09-anomaly-detection/README.md).
...
AIOps lessons (aligned with [07 — Kafka](../07-kafka/README.md)):
...
> [!TIP]
> **Meta-observability**
> Big Tech learned early: *the observation system is also a production system*. If Kafka lag is 15 minutes, “real-time anomaly” is marketing. Measure pipeline SLIs separately — see [14](../14-production-engine/README.md).
...
**Handle:** private model / VPC endpoint / redaction layer; minimize PII in tool outputs — see [12](../12-investigation-engine/README.md) and security in [14](../14-production-engine/README.md).
...
| Detection algorithms | [09 — Anomaly Detection](../09-anomaly-detection/README.md) |
| Noise reduction | [10 — Alert Correlation](../10-alert-correlation/README.md) |
| Diagnosis | [11 — Root Cause Analysis](../11-root-cause-analysis/README.md) |
| Investigation agent | [12 — LLM Agent](../12-investigation-engine/README.md) |
| Safe action | [13 — Remediation](../13-remediation-safety/README.md) |
| Platform operations | [14 — Production](../14-production-engine/README.md) |
...
Detailed implementation: [13 — Remediation](../13-remediation-safety/README.md).
...
Carry checklist §12 into [14 — Production](../14-production-engine/README.md), train/serve discipline into [09](../09-anomaly-detection/README.md), dual-control into [13](../13-remediation-safety/README.md), SLO culture into [01](../01-observability/README.md). Big Tech does not need you to look like them — they need (and you need) your system to **understand its own limits**.
