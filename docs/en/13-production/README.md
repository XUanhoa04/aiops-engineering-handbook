...
- [10 — LLM Agent](../11-llm-agent/README.md) — cost runaway LLM, human override
- [11 — Remediation](../12-remediation/README.md) — safety gates, blast radius
- [13 — Big Tech AIOps](../14-bigtech-aiops/README.md) — operating models & maturity at scale
- [14 — E-commerce & Banking](../15-ecommerce-banking/README.md) — cost/compliance constraints by industry
- [15 — Famous Incidents](../16-famous-incidents/README.md) — game day scenarios from public outages

## Next Reading

After this chapter, continue to [13 — Big Tech AIOps](../14-bigtech-aiops/README.md) to learn patterns from Google/Netflix/AWS/Meta/Uber, then [14 — E-commerce & Banking](../15-ecommerce-banking/README.md) and [15 — Famous Incidents](../16-famous-incidents/README.md).
...
Big Tech patterns to benchmark against: [13 — Big Tech AIOps](../14-bigtech-aiops/README.md). Industry constraints: [14 — E-commerce & Banking](../15-ecommerce-banking/README.md).
...
Cross-read: [13 — Big Tech AIOps](../14-bigtech-aiops/README.md) · [14 — E-commerce & Banking](../15-ecommerce-banking/README.md) · [15 — Famous Incidents](../16-famous-incidents/README.md).
