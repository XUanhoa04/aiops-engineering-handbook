# Chapter 13 — AIOps & SRE at large technology companies
...
- [07 — Anomaly Detection](../07-anomaly-detection/README.md) — anomaly signals, false positive economics
- [09 — Root Cause Analysis](../09-root-cause-analysis/README.md) — topology, change correlation, evidence ranking
- [11 — Automated Remediation](../11-remediation/README.md) — safety gate, blast radius, dual-control
- [12 — Production Operations](../12-production/README.md) — chaos, DR, runbook, platform self-observability

## Related Documents

- [08 — Alert Correlation](../08-alert-correlation/README.md) — noise reduction, incident grouping
- [10 — LLM Agent](../10-llm-agent/README.md) — agentic investigation, human-in-the-loop
- [06 — Kafka](../06-kafka/README.md) — event backbone for the AIOps pipeline

## Next Reading

After this chapter, continue to [14 — E-commerce & Banking](../14-ecommerce-banking/README.md) to apply patterns by money/transaction domain; then [15 — Famous Incidents](../15-famous-incidents/README.md) for postmortem drills. You can return to [12 — Production](../12-production/README.md) with a Big Tech checklist.
...
4. **Cargo cult autonomy**: “full closed-loop” auto-remediation without dual-control, audit trail, and a blast radius model — see [11 — Remediation](../11-remediation/README.md).
...
- AIOps tickets need a handoff schema: timeline, hypotheses, actions taken, blast radius — see [09 — RCA](../09-root-cause-analysis/README.md) and [10 — LLM Agent](../10-llm-agent/README.md).
...
5. Post-experiment note attached to knowledge base (feeds [10 — LLM Agent](../10-llm-agent/README.md)).

### 3.5 Netflix lessons for AIOps

1. **Resilience is a product requirement**, not an afterthought of detection.
2. **Steady-state metrics** must live in anomaly baselines — see seasonality in [07](../07-anomaly-detection/README.md).
...
See [12 — Production](../12-production/README.md) on chaos for the AIOps platform itself: the monitoring platform must survive losing a Kafka partition, an LLM provider, or one collector — otherwise AIOps becomes a single point of blindness.
...
Direct connection to [11 — Remediation](../11-remediation/README.md):
...
From [08 — Alert Correlation](../08-alert-correlation/README.md) and [09 — RCA](../09-root-cause-analysis/README.md):
...
> [!NOTE]
> **KEY IDEA**
> Many “ML anomaly does not work” cases are not weak algorithms — they are **weak data contracts**. Before swapping LSTM for Transformer, audit train/serve skew. See feature engineering in [07 — Anomaly Detection](../07-anomaly-detection/README.md).
...
AIOps lessons (aligned with [06 — Kafka](../06-kafka/README.md)):
...
> [!TIP]
> **Meta-observability**
> Big Tech learned early: *the observation system is also a production system*. If Kafka lag is 15 minutes, “real-time anomaly” is marketing. Measure pipeline SLIs separately — see [12](../12-production/README.md).
...
**Handle:** private model / VPC endpoint / redaction layer; minimize PII in tool outputs — see [10](../10-llm-agent/README.md) and security in [12](../12-production/README.md).
...
| Detection algorithms | [07 — Anomaly Detection](../07-anomaly-detection/README.md) |
| Noise reduction | [08 — Alert Correlation](../08-alert-correlation/README.md) |
| Diagnosis | [09 — Root Cause Analysis](../09-root-cause-analysis/README.md) |
| Investigation agent | [10 — LLM Agent](../10-llm-agent/README.md) |
| Safe action | [11 — Remediation](../11-remediation/README.md) |
| Platform operations | [12 — Production](../12-production/README.md) |
...
Detailed implementation: [11 — Remediation](../11-remediation/README.md).
...
Carry checklist §12 into [12 — Production](../12-production/README.md), train/serve discipline into [07](../07-anomaly-detection/README.md), dual-control into [11](../11-remediation/README.md), SLO culture into [01](../01-observability/README.md). Big Tech does not need you to look like them — they need (and you need) your system to **understand its own limits**.
