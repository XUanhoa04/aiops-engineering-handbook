...
- [09 — Anomaly Detection](../09-anomaly-detection/README.md) — anomaly signals as input to RCA
- [10 — Alert Correlation](../10-alert-correlation/README.md) — correlated incident groups
- [04 — Loki](../04-loki/README.md) — logs as RCA evidence
- [05 — Tempo](../05-tempo/README.md) — traces as RCA evidence

## Related Documents

- [12 — LLM Agent](../12-investigation-engine/README.md) — uses RCA output for investigation and handling
- [13 — Remediation](../13-remediation-safety/README.md) — RCA results help guide remediation option selection
- [14 — Production Operations](../14-production-engine/README.md) — measure RCA accuracy, game day drills
- [15 — Big Tech AIOps](../15-bigtech-aiops/README.md) — RCA / incident diagnosis patterns at Big Tech
- [16 — E-commerce & Banking](../16-ecommerce-banking/README.md) — RCA for payment cascade, fraud false-positive confounds
- [17 — Famous Incidents](../17-famous-incidents/README.md) — correlation≠causation lessons from real outages

## Next Reading

After this chapter, continue to [12 — LLM Agent](../12-investigation-engine/README.md).
...
> [!IMPORTANT]
> Any automated remediation pipeline (Chapter 13) may only attach to RCA when **confidence + evidence quality** exceed the threshold *and* the failure mode is on the allowlist. Wrong RCA + auto-remediate = AIOps-caused outage.
...
| Change events | CI/CD, GitOps, feature flags, infra tickets ([08](../08-topology-change/README.md)) | Candidate causes |
...
Real outage lessons: [17 — Famous Incidents](../17-famous-incidents/README.md).
...
Drill RCA on famous outages: [17 — Famous Incidents](../17-famous-incidents/README.md) · operating accuracy: [14 — Production](../14-production-engine/README.md).
...
3. **RCA analysis output is a hypothesis, not absolute truth**. The RCA results UI must clearly show confidence scores with concrete supporting evidence. Never auto-trigger destructive remediation actions based purely on RCA without on-call approval (details in Chapter 13).
