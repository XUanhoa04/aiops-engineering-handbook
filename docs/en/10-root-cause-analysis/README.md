...
- [07 — Anomaly Detection](../08-anomaly-detection/README.md) — anomaly signals as input to RCA
- [08 — Alert Correlation](../09-alert-correlation/README.md) — correlated incident groups
- [04 — Loki](../04-loki/README.md) — logs as RCA evidence
- [05 — Tempo](../05-tempo/README.md) — traces as RCA evidence

## Related Documents

- [10 — LLM Agent](../11-llm-agent/README.md) — uses RCA output for investigation and handling
- [11 — Remediation](../12-remediation/README.md) — RCA results help guide remediation option selection
- [12 — Production Operations](../13-production/README.md) — measure RCA accuracy, game day drills
- [13 — Big Tech AIOps](../14-bigtech-aiops/README.md) — RCA / incident diagnosis patterns at Big Tech
- [14 — E-commerce & Banking](../15-ecommerce-banking/README.md) — RCA for payment cascade, fraud false-positive confounds
- [15 — Famous Incidents](../16-famous-incidents/README.md) — correlation≠causation lessons from real outages

## Next Reading

After this chapter, continue to [10 — LLM Agent](../11-llm-agent/README.md).
...
Real outage lessons: [15 — Famous Incidents](../16-famous-incidents/README.md).
...
Drill RCA on famous outages: [15 — Famous Incidents](../16-famous-incidents/README.md) · operating accuracy: [12 — Production](../13-production/README.md).
