...
- [10 — Alert Correlation](../10-alert-correlation/README.md) — receives anomaly events
- [11 — Root Cause Analysis](../11-root-cause-analysis/README.md) — uses anomaly context
- [12 — LLM Agent](../12-investigation-engine/README.md) — uses anomaly signals for incident investigation
- [14 — Production Operations](../14-production-engine/README.md) — running detectors in production, platform SLOs
- [15 — Big Tech AIOps](../15-bigtech-aiops/README.md) — how Google/Meta/Netflix run detection at scale
- [16 — E-commerce & Banking](../16-ecommerce-banking/README.md) — Black Friday seasonality, compliance, latency-critical detection
- [17 — Famous Incidents](../17-famous-incidents/README.md) — case studies of drift/deploy-induced false alarms in real incidents

## Next Reading

After this chapter, continue to [10 — Alert Correlation](../10-alert-correlation/README.md).
...
See commercial seasonality scenarios in [16 — E-commerce & Banking](../16-ecommerce-banking/README.md) and real drift incidents in [17 — Famous Incidents](../17-famous-incidents/README.md).
...
Platform-level operations: [14 — Production](../14-production-engine/README.md). How Big Tech tiers detection: [15 — Big Tech AIOps](../15-bigtech-aiops/README.md).
