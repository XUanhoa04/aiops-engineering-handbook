...
- [09 — Anomaly Detection](../09-anomaly-detection/README.md) — precision-at-page, drift ops
- [10 — Alert Correlation](../10-alert-correlation/README.md) — storm drills, topology health
- [11 — Root Cause Analysis](../11-root-cause-analysis/README.md) — accuracy feedback, time budget
- [12 — LLM Agent](../12-investigation-engine/README.md) — cost runaway LLM, human override
- [13 — Remediation](../13-remediation-safety/README.md) — safety gates, blast radius
- [15 — Big Tech AIOps](../15-bigtech-aiops/README.md) — operating models & maturity at scale
- [16 — E-commerce & Banking](../16-ecommerce-banking/README.md) — cost/compliance constraints by industry
- [17 — Famous Incidents](../17-famous-incidents/README.md) — game day scenarios from public outages

## Next Reading

After this chapter, continue to [15 — Big Tech AIOps](../15-bigtech-aiops/README.md) to learn patterns from Google/Netflix/AWS/Meta/Uber, then [16 — E-commerce & Banking](../16-ecommerce-banking/README.md) and [17 — Famous Incidents](../17-famous-incidents/README.md).
...
See also public DR/outage scenarios to drill: [17 — Famous Incidents](../17-famous-incidents/README.md).
...
| Bi-annual | Famous incident replay | Organizational learning | [17 — Famous Incidents](../17-famous-incidents/README.md) |
...
Big Tech patterns to benchmark against: [15 — Big Tech AIOps](../15-bigtech-aiops/README.md). Industry constraints: [16 — E-commerce & Banking](../16-ecommerce-banking/README.md).
...
Cross-read: [15 — Big Tech AIOps](../15-bigtech-aiops/README.md) · [16 — E-commerce & Banking](../16-ecommerce-banking/README.md) · [17 — Famous Incidents](../17-famous-incidents/README.md).
