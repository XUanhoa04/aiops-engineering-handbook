...
DIAGRAMS = [
    ...
    (
        ...
        [
            ...
            ("consumerst", "AIOps consumers", "amber", [("enricht", "Ch.06 point-in-time enrichment", "white"), ("correlt", "Ch.10 grouping / split", "white"), ("rcat", "Ch.11 downstream weighting", "white"), ("safet", "Ch.13 blast radius / freeze", "white")]),
        ],
...
EXTRA_DIAGRAMS = [
    ...
    ("20-predictive-operations.png", "Predictive operations — forecast constraints, decide before impact", [("inputpred", "Demand and context", "blue", [("demandpred", "Accepted · rejected · retried demand", "white"), ("eventpred", "Campaign · deploy · quota reset", "white"), ("topopred", "Topology + shared constraints", "white")]), ("forecastpred", "Multi-horizon forecast", "cyan", [("shortpred", "5–15 min feedback window", "white"), ("longpred", "1 h–7 d capacity window", "white"), ("intervalpred", "P50 · P90 · uncertainty", "white")]), ("riskpred", "Capacity risk", "green", [("constraintpred", "Hard limit + failover reserve", "white"), ("ttepred", "Earliest/latest breach", "white"), ("impactpred", "Downstream journey impact", "white")]), ("decisionpred", "Decision state", "violet", [("watchpred", "Observe · watch · actionable", "white"), ("refusepred", "Refuse stale / missing context", "white"), ("proposalpred", "Cost-aware typed proposal", "white")]), ("outpred", "Safe outcome", "amber", [("gatepred", "Safety gates + coordination", "white"), ("verifypred", "Headroom + SLI verification", "white")])], [("demandpred", "shortpred", "", ""), ("eventpred", "longpred", "prior", ""), ("topopred", "constraintpred", "", ""), ("shortpred", "intervalpred", "", ""), ("longpred", "intervalpred", "", ""), ("intervalpred", "ttepred", "", ""), ("constraintpred", "ttepred", "", ""), ("topopred", "impactpred", "", ""), ("ttepred", "watchpred", "", ""), ("impactpred", "proposalpred", "", ""), ("intervalpred", "refusepred", "quality gate", ""), ("watchpred", "gatepred", "", ""), ("proposalpred", "gatepred", "", ""), ("gatepred", "verifypred", "", "")], [("n20", "Forecast accuracy is not enough:\nactionable lead time and calibration decide", "ttepred")]),
    ("21-incident-operations.png", "Incident operations — one command state across people and engines", [("inputops", "Operational inputs", "blue", [("incidentops", "Correlated incident + impact", "white"), ("evidenceops", "RCA / investigation revisions", "white"), ("peopleops", "Responders + service owners", "white")]), ("commandops", "Command state", "cyan", [("stateops", "Declare · mitigate · recover", "white"), ("roleops", "IC · Operations · Comms leases", "white")]), ("ledgerops", "Immutable ledgers", "green", [("decisionops", "Decision + alternatives", "white"), ("actionops", "Action + effect-domain lock", "white"), ("commsops", "Confirmed claims + cadence", "white")]), ("coordops", "Coordination", "violet", [("splitops", "Split · relate · merge faults", "white"), ("handoffops", "Explicit multi-hour handoff", "white"), ("degradedops", "Out-of-band degraded path", "white")]), ("outcomeops", "Operational truth", "amber", [("impactops", "User impact + backlog recovery", "white"), ("replayops", "Complete replay / postmortem", "white")])], [("incidentops", "stateops", "", ""), ("evidenceops", "stateops", "", ""), ("peopleops", "roleops", "", ""), ("stateops", "decisionops", "", ""), ("roleops", "actionops", "authority", ""), ("decisionops", "splitops", "", ""), ("actionops", "handoffops", "", ""), ("commsops", "handoffops", "", ""), ("splitops", "impactops", "", ""), ("handoffops", "impactops", "", ""), ("degradedops", "impactops", "bypass", ""), ("impactops", "replayops", "", "")], [("n21", "Two overlapping failures keep separate state\nbut share one coordination truth", "splitops")]),
    ("22-aiops-governance.png", "AIOps governance — authority expires when evidence no longer holds", [("inventorygov", "Capability inventory", "blue", [("datagov", "Data · feature · topology", "white"), ("modelgov", "Rule · model · prompt · retrieval", "white"), ("toolgov", "Tool · action · policy", "white")]), ("riskgov", "Risk and scope", "cyan", [("tiergov", "G0 observe → G3 critical act", "white"), ("scopegov", "Service · tenant · region", "white"), ("expirygov", "Acceptance + invalidation", "white")]), ("evaluategov", "Evaluation portfolio", "green", [("replaygov", "Replay · red team · shadow", "white"), ("calgov", "Calibration · cohort · abstain", "white")]), ("enforcegov", "Runtime enforcement", "violet", [("brokergov", "Least-privilege tool broker", "white"), ("gategov", "Hard gates before score", "white"), ("revokegov", "Restrict · suspend · revoke", "white")]), ("evidencegov", "Governance evidence", "amber", [("envelopegov", "Versioned decision envelope", "white"), ("outcomegov", "Outcome · audit · owner", "white")])], [("datagov", "tiergov", "", ""), ("modelgov", "scopegov", "", ""), ("toolgov", "tiergov", "", ""), ("tiergov", "replaygov", "", ""), ("scopegov", "calgov", "", ""), ("expirygov", "gategov", "", ""), ("replaygov", "brokergov", "accept", ""), ("calgov", "gategov", "", ""), ("brokergov", "envelopegov", "", ""), ("gategov", "envelopegov", "", ""), ("revokegov", "brokergov", "fence", "dashed"), ("envelopegov", "outcomegov", "", "")], [("n22", "Confidence never grants authority;\nrisk tier and hard gates do", "gategov")]),
]
